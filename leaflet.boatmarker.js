...
L.boatMarker = function(pos, options) {
	...
	var xf = ("x_fac" in options) ? options.x_fac : 0.18;
	var yf = ("y_fac" in options) ? options.y_fac : 0.18;
	options.icon = new L.BoatIcon({ color: c, idleCircle: i, x_fac: xf, y_fac: yf});
